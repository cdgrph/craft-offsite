...
- Credentials are read from environment variables or the AWS SDK credential chain; they are never persisted to the database or project config, and `craft offsite/diagnose` output is redacted.
